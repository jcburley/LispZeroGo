/*
   ...
   2018-08-31 jcburley: Hand-modified version of c2go-generated variant of lisp-zero-single.c

   This version has interesting performance characteristics on my MacBook Pro (pony):
...
craig@pony:~/github/LispZero/perftests (master u=)$
   ...
   making use of more than one thread, though my (original) code
   doesn't explicitly do anything to cause that -- maybe an
   underlying-I/O thing?
